/* @ts-self-types="./ai_art_analyzer.d.ts" */
...
export class Analyzer {
     ...
     */
    analyze() {
        const ret = wasm.analyzer_analyze(this.__wbg_ptr);
        return ret;
    }
    /**
    ...
    constructor(data, width, height) {
        ...
        const ret = wasm.analyzer_new(ptr0, len0, width, height);
...
async function __wbg_init(module_or_path) {
    ...
    if (module_or_path === undefined) {
        module_or_path = new URL('ai_art_analyzer_bg.wasm', import.meta.url);
    }
    const imports = __wbg_get_imports();
